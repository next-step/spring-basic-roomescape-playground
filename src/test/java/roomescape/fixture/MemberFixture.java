...
public class MemberFixture {
    ...
    public static Member 어드민_생성() {
        return new Member("어드민", "admin@email.com", "password", Role.ADMIN);
    }
    public static Member 브라운_생성() {
        return new Member("브라운", "brown@email.com", "password", Role.USER);
    }
